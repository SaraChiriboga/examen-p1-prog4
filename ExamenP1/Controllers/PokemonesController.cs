...
namespace ExamenP1.Controllers
{
    public class PokemonesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Pokemon pokemon = db.Pokemones.Find(id);
            if (pokemon == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Tipo,NivelPoder,Habilidad")] Pokemon pokemon)
        {
            if (ModelState.IsValid)
            {
                db.Pokemones.Add(pokemon);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Tipo,NivelPoder,Habilidad")] Pokemon pokemon)
        {
            if (ModelState.IsValid)
            {
